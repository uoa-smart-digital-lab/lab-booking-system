...
<script lang="ts">
  ...
  import { Button, Image, SvelteUIProvider, Modal } from '@svelteuidev/core';
  ...
  function updateUI (_ : {} = {}) { 
      ...
      appVars.message = (
          ...
          :
              "Welcome to the SDL / TTL Booking System Admin.  This is still under heavy development, so for now, this is only test data.  \
